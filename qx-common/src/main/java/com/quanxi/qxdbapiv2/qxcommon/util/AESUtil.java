...
public class AESUtil {
    ...
    private static final String ENCODE_RULES = "quanxi";
    ...
    public static String aesDecode(String content) {
        try {
            ...
            throw new RuntimeException("配置文件中的密码需要使用AES加密，请使用AESUtil工具类修改这些值！");
            //e.printStackTrace();
        } catch (BadPaddingException e) {
            e.printStackTrace();
        }
    ...
    public static void main(String[] args) {
        String[] keys = {
                "Qxyl201811", "123456", "ONn6Pd6XcfndtSkRIRFHvw=="
        };
