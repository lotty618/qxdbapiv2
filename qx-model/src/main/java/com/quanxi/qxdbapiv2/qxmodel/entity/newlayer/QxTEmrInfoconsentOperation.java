...
@Table(name = "QX_T_EMR_INFOCONSENT_OPERATION")
public class QxTEmrInfoconsentOperation {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取手术同意书唯一标识
     *
     * @return INORUID - 手术同意书唯一标识
     */
    public String getInoruid() {
        return inoruid;
    }
     ...
     * 设置手术同意书唯一标识
     *
     * @param inoruid 手术同意书唯一标识
     */
    public void setInoruid(String inoruid) {
        this.inoruid = inoruid == null ? null : inoruid.trim();
    }
