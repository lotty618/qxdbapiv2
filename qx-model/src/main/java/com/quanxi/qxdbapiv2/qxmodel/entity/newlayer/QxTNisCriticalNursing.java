...
@Table(name = "QX_T_NIS_CRITICAL_NURSING")
public class QxTNisCriticalNursing {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
     ...
     */
    @Id
    @Column(name = "CRITICAL_NURSING_ID")
    private String criticalNursingId;
    ...
    /**
     * 血糖检测值（mmol/L）（空腹时血液中葡萄糖定量检测结果值，计量单位为 mmol/L）
     */
    @Column(name = "GLU")
     ...
     * 呼吸机监护项目（对呼吸机监测项目的描述）
     */
    @Column(name = "VENTILATOR_MONITOR_ITEM")
    private String ventilatorMonitorItem;
     ...
     *
     * @return CRITICAL_NURSING_ID - 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    public String getCriticalNursingId() {
        return criticalNursingId;
    }

    /**
     * 设置序列号[主键]（每条记录在数据库中的唯一序号）
     *
     * @param criticalNursingId 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    public void setCriticalNursingId(String criticalNursingId) {
        this.criticalNursingId = criticalNursingId == null ? null : criticalNursingId.trim();
    }
    ...
    /**
     * 获取血糖检测值（mmol/L）（空腹时血液中葡萄糖定量检测结果值，计量单位为 mmol/L）
     *
     * @return GLU - 血糖检测值（mmol/L）（空腹时血液中葡萄糖定量检测结果值，计量单位为 mmol/L）
     */
    ...
    /**
     * 设置血糖检测值（mmol/L）（空腹时血液中葡萄糖定量检测结果值，计量单位为 mmol/L）
     *
     * @param glu 血糖检测值（mmol/L）（空腹时血液中葡萄糖定量检测结果值，计量单位为 mmol/L）
     */
    ...
    /**
     * 获取呼吸机监护项目（对呼吸机监测项目的描述）
     *
     * @return VENTILATOR_MONITOR_ITEM - 呼吸机监护项目（对呼吸机监测项目的描述）
     */
    public String getVentilatorMonitorItem() {
        return ventilatorMonitorItem;
    }

    /**
     * 设置呼吸机监护项目（对呼吸机监测项目的描述）
     *
     * @param ventilatorMonitorItem 呼吸机监护项目（对呼吸机监测项目的描述）
     */
    public void setVentilatorMonitorItem(String ventilatorMonitorItem) {
        this.ventilatorMonitorItem = ventilatorMonitorItem == null ? null : ventilatorMonitorItem.trim();
    }
