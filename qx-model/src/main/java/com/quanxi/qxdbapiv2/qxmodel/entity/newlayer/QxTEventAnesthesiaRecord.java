...
@Table(name = "QX_T_EVENT_ANESTHESIA_RECORD")
public class QxTEventAnesthesiaRecord {
    /**
     * 序列号
     */
    @Id
     ...
     */
    public void setAnesCompCode(Long anesCompCode) {
        this.anesCompCode = anesCompCode;
    }
     ...
     */
    public Long getLossbloodAmount() {
     ...
     */
    public void setLossbloodAmount(Long lossbloodAmount) {
