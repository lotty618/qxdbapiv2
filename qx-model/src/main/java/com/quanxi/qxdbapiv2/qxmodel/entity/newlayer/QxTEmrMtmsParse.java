...
@Table(name = "QX_T_EMR_MTMS_PARSE")
public class QxTEmrMtmsParse {
    /**
     * 序列号
     */
    @Column(name = "SID")
    ...
    /**
     * 获取签名状态（0：未签，1：部分签，2全签）
     *
     * @return SIGNATURE_STATUS - 签名状态（0：未签，1：部分签，2全签）
     */
    public Long getSignatureStatus() {
        return signatureStatus;
    }

    /**
     * 设置签名状态（0：未签，1：部分签，2全签）
     *
     * @param signatureStatus 签名状态（0：未签，1：部分签，2全签）
     */
    public void setSignatureStatus(Long signatureStatus) {
