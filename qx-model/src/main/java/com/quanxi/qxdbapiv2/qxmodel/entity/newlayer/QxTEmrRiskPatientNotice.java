...
@Table(name = "QX_T_EMR_RISK_PATIENT_NOTICE")
public class QxTEmrRiskPatientNotice {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取高风险患者告知书唯一标识
     *
     * @return ERPNUID - 高风险患者告知书唯一标识
     */
    public String getErpnuid() {
        return erpnuid;
    }
     ...
     * 设置高风险患者告知书唯一标识
     *
     * @param erpnuid 高风险患者告知书唯一标识
     */
    public void setErpnuid(String erpnuid) {
        this.erpnuid = erpnuid == null ? null : erpnuid.trim();
    }
