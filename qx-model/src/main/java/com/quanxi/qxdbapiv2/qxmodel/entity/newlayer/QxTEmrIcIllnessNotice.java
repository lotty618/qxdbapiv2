...
@Table(name = "QX_T_EMR_IC_ILLNESS_NOTICE")
public class QxTEmrIcIllnessNotice {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取其他记录唯一标识
     *
     * @return EIINUID - 其他记录唯一标识
     */
    public String getEiinuid() {
        return eiinuid;
    }
     ...
     * 设置其他记录唯一标识
     *
     * @param eiinuid 其他记录唯一标识
     */
    public void setEiinuid(String eiinuid) {
        this.eiinuid = eiinuid == null ? null : eiinuid.trim();
    }
