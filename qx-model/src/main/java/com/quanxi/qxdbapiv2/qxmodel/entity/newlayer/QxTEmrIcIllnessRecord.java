...
@Table(name = "QX_T_EMR_IC_ILLNESS_RECORD")
public class QxTEmrIcIllnessRecord {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取告病重病危的记录唯一标识
     *
     * @return ENURUID - 告病重病危的记录唯一标识
     */
    public String getEnuruid() {
        return enuruid;
    }
     ...
     * 设置告病重病危的记录唯一标识
     *
     * @param enuruid 告病重病危的记录唯一标识
     */
    public void setEnuruid(String enuruid) {
        this.enuruid = enuruid == null ? null : enuruid.trim();
    }
