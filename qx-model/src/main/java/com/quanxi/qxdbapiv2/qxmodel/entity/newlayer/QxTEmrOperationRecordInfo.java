...
@Table(name = "QX_T_EMR_OPERATION_RECORD_INFO")
public class QxTEmrOperationRecordInfo {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取手术记录唯一标识
     *
     * @return EOPRUID - 手术记录唯一标识
     */
    public String getEopruid() {
        return eopruid;
    }
     ...
     * 设置手术记录唯一标识
     *
     * @param eopruid 手术记录唯一标识
     */
    public void setEopruid(String eopruid) {
        this.eopruid = eopruid == null ? null : eopruid.trim();
    }
