...
@Table(name = "QX_T_EMR_INFAUST_REPORT")
public class QxTEmrInfaustReport {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取不良事件单唯一标识
     *
     * @return EINRUID - 不良事件单唯一标识
     */
    public String getEinruid() {
        return einruid;
    }
     ...
     * 设置不良事件单唯一标识
     *
     * @param einruid 不良事件单唯一标识
     */
    public void setEinruid(String einruid) {
        this.einruid = einruid == null ? null : einruid.trim();
    }
