...
@Table(name = "QX_T_INPATIENT_DIAG")
public class QxTInpatientDiag {
    /**
     * 序列号
     */
    @Id
    ...
    /**
     * 诊断代码ICD-10（诊断在特定编码体系中的编码）
     */
    @Column(name = "DIAG_CODE")
    private String diagCode;

    /**
     * 诊断名称（患者的临床诊断在特定分类体系中的名称，这里指主要疾病诊断名称 ）
     */
     ...
     * 设置出院诊断唯一标识
     *
     * @param iduid 出院诊断唯一标识
     */
    public void setIduid(String iduid) {
        this.iduid = iduid == null ? null : iduid.trim();
    }
    ...
    /**
     * 获取诊断代码ICD-10（诊断在特定编码体系中的编码）
     *
     * @return DIAG_CODE - 诊断代码ICD-10（诊断在特定编码体系中的编码）
     */
    ...
    /**
     * 设置诊断代码ICD-10（诊断在特定编码体系中的编码）
     *
     * @param diagCode 诊断代码ICD-10（诊断在特定编码体系中的编码）
     */
    ...
    /**
     * 获取诊断名称（患者的临床诊断在特定分类体系中的名称，这里指主要疾病诊断名称 ）
     *
     * @return DIAG_NAME - 诊断名称（患者的临床诊断在特定分类体系中的名称，这里指主要疾病诊断名称 ）
     */
    ...
    /**
     * 设置诊断名称（患者的临床诊断在特定分类体系中的名称，这里指主要疾病诊断名称 ）
     *
     * @param diagName 诊断名称（患者的临床诊断在特定分类体系中的名称，这里指主要疾病诊断名称 ）
     */
