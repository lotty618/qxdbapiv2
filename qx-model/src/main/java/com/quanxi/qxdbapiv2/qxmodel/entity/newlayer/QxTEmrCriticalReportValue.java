...
@Table(name = "QX_T_EMR_CRITICAL_REPORT_VALUE")
public class QxTEmrCriticalReportValue {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取报告危急值单唯一标识
     *
     * @return ECRVUID - 报告危急值单唯一标识
     */
    public String getEcrvuid() {
        return ecrvuid;
    }
     ...
     * 设置报告危急值单唯一标识
     *
     * @param ecrvuid 报告危急值单唯一标识
     */
    public void setEcrvuid(String ecrvuid) {
        this.ecrvuid = ecrvuid == null ? null : ecrvuid.trim();
    }
