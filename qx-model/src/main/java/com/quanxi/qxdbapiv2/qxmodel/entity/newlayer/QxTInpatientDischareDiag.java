...
@Table(name = "QX_T_INPATIENT_DISCHARE_DIAG")
public class QxTInpatientDischareDiag {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取出院诊断唯一标识
     *
     * @return IDDUID - 出院诊断唯一标识
     */
    public String getIdduid() {
        return idduid;
    }
     ...
     * 设置出院诊断唯一标识
     *
     * @param idduid 出院诊断唯一标识
     */
    public void setIdduid(String idduid) {
        this.idduid = idduid == null ? null : idduid.trim();
    }
    ...
    /**
     * 获取治疗结果代码（出院时住院者每种疾病的治疗结果代码 ）
     *
     * @return TREAT_RESULT_CODE - 治疗结果代码（出院时住院者每种疾病的治疗结果代码 ）
     */
    ...
    /**
     * 设置治疗结果代码（出院时住院者每种疾病的治疗结果代码 ）
     *
     * @param treatResultCode 治疗结果代码（出院时住院者每种疾病的治疗结果代码 ）
     */
