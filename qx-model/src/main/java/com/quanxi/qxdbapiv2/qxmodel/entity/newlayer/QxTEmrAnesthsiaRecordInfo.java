...
@Table(name = "QX_T_EMR_ANESTHSIA_RECORD_INFO")
public class QxTEmrAnesthsiaRecordInfo {
    /**
     * 序列号
     */
    @Column(name = "SID")
     ...
     * 获取麻醉记录唯一标识
     *
     * @return EATRUID - 麻醉记录唯一标识
     */
    public String getEatruid() {
        return eatruid;
    }
     ...
     * 设置麻醉记录唯一标识
     *
     * @param eatruid 麻醉记录唯一标识
     */
    public void setEatruid(String eatruid) {
        this.eatruid = eatruid == null ? null : eatruid.trim();
    }
