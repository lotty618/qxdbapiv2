...
@Table(name = "QX_TP_MED_RELATION")
public class QxTpMedRelation {
    /**
     * 序列号
     */
    @Column(name = "SID")
    ...
    /**
     * 组织机构编码DIR_ORG（医疗机构经《医疗机构执业许可证》登记的，并按照特定编码体系填写的代码）
     */
    @Column(name = "ORG_ID")
     ...
     * 获取药品厂家关系标识
     *
     * @return PMRUID - 药品厂家关系标识
     */
    public String getPmruid() {
        return pmruid;
    }
     ...
     * 设置药品厂家关系标识
     *
     * @param pmruid 药品厂家关系标识
     */
    public void setPmruid(String pmruid) {
        this.pmruid = pmruid == null ? null : pmruid.trim();
    }
    ...
    /**
     * 获取组织机构编码DIR_ORG（医疗机构经《医疗机构执业许可证》登记的，并按照特定编码体系填写的代码）
     *
     * @return ORG_ID - 组织机构编码DIR_ORG（医疗机构经《医疗机构执业许可证》登记的，并按照特定编码体系填写的代码）
     */
    ...
    /**
     * 设置组织机构编码DIR_ORG（医疗机构经《医疗机构执业许可证》登记的，并按照特定编码体系填写的代码）
     *
     * @param orgId 组织机构编码DIR_ORG（医疗机构经《医疗机构执业许可证》登记的，并按照特定编码体系填写的代码）
     */
