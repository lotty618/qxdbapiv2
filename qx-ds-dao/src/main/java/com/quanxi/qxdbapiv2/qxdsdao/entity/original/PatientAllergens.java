...
public class PatientAllergens {
    ...
    /**
     * 药物过敏源代码[主键]CV05.01.038（诱发本人过敏性疾病的药物代码）
     */
    @Id
    ...
    /**
     * 获取药物过敏源代码[主键]CV05.01.038（诱发本人过敏性疾病的药物代码）
     *
     * @return ALLERGENS_CODE - 药物过敏源代码[主键]CV05.01.038（诱发本人过敏性疾病的药物代码）
     */
    ...
    /**
     * 设置药物过敏源代码[主键]CV05.01.038（诱发本人过敏性疾病的药物代码）
     *
     * @param allergensCode 药物过敏源代码[主键]CV05.01.038（诱发本人过敏性疾病的药物代码）
     */
