...
@Table(name = "INFOCONSENT_ILLNESS_NOTICE")
public class InfoconsentIllnessNotice {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 病情概括及主要抢救措施（病危（重）通知书中的病情概括及主要抢救措施的描述，包括神志、生命体征、主要器官功能的描述）
     */
    @Column(name = "MAIN_MEASURE")
    private String mainMeasure;

    /**
     * 病危（重）通知内容（患者病情危、重时，由经治医师或值班医师向患者家属告知病情危重情况的详细描述）
     */
    @Column(name = "CRITICALLY_NOTICE_CONTENT")
    private String criticallyNoticeContent;

    /**
     * 病危（重）通知日期时间（病危（重）通知书下达时的公元纪年日期和时间的完整描述）
     */
    @Column(name = "CRITICALLY_NOTICE_DATE")
    private String criticallyNoticeDate;
    ...
    /**
     * 获取病情概括及主要抢救措施（病危（重）通知书中的病情概括及主要抢救措施的描述，包括神志、生命体征、主要器官功能的描述）
     *
     * @return MAIN_MEASURE - 病情概括及主要抢救措施（病危（重）通知书中的病情概括及主要抢救措施的描述，包括神志、生命体征、主要器官功能的描述）
     */
    ...
    /**
     * 设置病情概括及主要抢救措施（病危（重）通知书中的病情概括及主要抢救措施的描述，包括神志、生命体征、主要器官功能的描述）
     *
     * @param mainMeasure 病情概括及主要抢救措施（病危（重）通知书中的病情概括及主要抢救措施的描述，包括神志、生命体征、主要器官功能的描述）
     */
    public void setMainMeasure(String mainMeasure) {
        this.mainMeasure = mainMeasure == null ? null : mainMeasure.trim();
    }

    /**
     * 获取病危（重）通知内容（患者病情危、重时，由经治医师或值班医师向患者家属告知病情危重情况的详细描述）
     *
     * @return CRITICALLY_NOTICE_CONTENT - 病危（重）通知内容（患者病情危、重时，由经治医师或值班医师向患者家属告知病情危重情况的详细描述）
     */
    public String getCriticallyNoticeContent() {
        return criticallyNoticeContent;
    }

    /**
     * 设置病危（重）通知内容（患者病情危、重时，由经治医师或值班医师向患者家属告知病情危重情况的详细描述）
     *
     * @param criticallyNoticeContent 病危（重）通知内容（患者病情危、重时，由经治医师或值班医师向患者家属告知病情危重情况的详细描述）
     */
    public void setCriticallyNoticeContent(String criticallyNoticeContent) {
        this.criticallyNoticeContent = criticallyNoticeContent == null ? null : criticallyNoticeContent.trim();
    }

    /**
     * 获取病危（重）通知日期时间（病危（重）通知书下达时的公元纪年日期和时间的完整描述）
     *
     * @return CRITICALLY_NOTICE_DATE - 病危（重）通知日期时间（病危（重）通知书下达时的公元纪年日期和时间的完整描述）
     */
    public String getCriticallyNoticeDate() {
        return criticallyNoticeDate;
    }

    /**
     * 设置病危（重）通知日期时间（病危（重）通知书下达时的公元纪年日期和时间的完整描述）
     *
     * @param criticallyNoticeDate 病危（重）通知日期时间（病危（重）通知书下达时的公元纪年日期和时间的完整描述）
     */
    public void setCriticallyNoticeDate(String criticallyNoticeDate) {
        this.criticallyNoticeDate = criticallyNoticeDate == null ? null : criticallyNoticeDate.trim();
    }
