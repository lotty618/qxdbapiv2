...
@Table(name = "EMR_DEATH_RECORD")
public class EmrDeathRecord {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 死亡原因类别代码DIR__DEATH_CATALOG（患者死亡原因类别在特定编码体系中的编码）
     */
    @Column(name = "DEATH_CAUSE_TYPE_CODE")
    private String deathCauseTypeCode;

    /**
     * 死亡原因类别中文名称（患者死亡原因类别在特定编码体系中的中文名称）
     */
    @Column(name = "DEATH_CAUSE_TYPE_CN")
    private String deathCauseTypeCn;

    /**
     * 死亡最高诊断机构级别代码DIR_RANK_CODE（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     */
    @Column(name = "HIGHEST_LEVEL_CODE")
    private String highestLevelCode;

    /**
     * 死亡最高诊断机构级别中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     */
    @Column(name = "HIGHEST_LEVEL_CN")
    private String highestLevelCn;

    /**
     * 死亡最高诊断机构代码DIR_ORG（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     */
    @Column(name = "HIGHEST_ORG_CODE")
    private String highestOrgCode;

    /**
     * 死亡最高诊断机构中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     */
    @Column(name = "HIGHEST_ORG_CN")
    private String highestOrgCn;

    /**
     * 死亡最高诊断依据类别代码CV05.01.037（对根本死因诊断的最高依据在特定编码体系中的代码）
     */
    @Column(name = "HIGHEST_DIAG_BASIS_CODE")
    private String highestDiagBasisCode;

    /**
     * 死亡最高诊断依据类别中文名称（对根本死因诊断的最高依据在特定编码体系中的中文名称）
     */
    @Column(name = "HIGHEST_DIAG_BASIS_CN")
    private String highestDiagBasisCn;

    /**
     * 家属是否同意尸体解剖标志0否 1是（标识患者家属是否同意进行尸体解剖的标志）
     */
    @Column(name = "AGREE_AUTOPSY_MARK")
    private String agreeAutopsyMark;
     ...
     *
     * @return DEATH_RECORD_ID - 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    public String getDeathRecordId() {
     ...
     *
     * @param deathRecordId 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    public void setDeathRecordId(String deathRecordId) {
        this.deathRecordId = deathRecordId == null ? null : deathRecordId.trim();
    }
    ...
    /**
     * 获取死亡原因类别代码DIR__DEATH_CATALOG（患者死亡原因类别在特定编码体系中的编码）
     *
     * @return DEATH_CAUSE_TYPE_CODE - 死亡原因类别代码DIR__DEATH_CATALOG（患者死亡原因类别在特定编码体系中的编码）
     */
    public String getDeathCauseTypeCode() {
        return deathCauseTypeCode;
    }

    /**
     * 设置死亡原因类别代码DIR__DEATH_CATALOG（患者死亡原因类别在特定编码体系中的编码）
     *
     * @param deathCauseTypeCode 死亡原因类别代码DIR__DEATH_CATALOG（患者死亡原因类别在特定编码体系中的编码）
     */
    public void setDeathCauseTypeCode(String deathCauseTypeCode) {
        this.deathCauseTypeCode = deathCauseTypeCode == null ? null : deathCauseTypeCode.trim();
    }

    /**
     * 获取死亡原因类别中文名称（患者死亡原因类别在特定编码体系中的中文名称）
     *
     * @return DEATH_CAUSE_TYPE_CN - 死亡原因类别中文名称（患者死亡原因类别在特定编码体系中的中文名称）
     */
    public String getDeathCauseTypeCn() {
        return deathCauseTypeCn;
    }

    /**
     * 设置死亡原因类别中文名称（患者死亡原因类别在特定编码体系中的中文名称）
     *
     * @param deathCauseTypeCn 死亡原因类别中文名称（患者死亡原因类别在特定编码体系中的中文名称）
     */
    public void setDeathCauseTypeCn(String deathCauseTypeCn) {
        this.deathCauseTypeCn = deathCauseTypeCn == null ? null : deathCauseTypeCn.trim();
    }

    /**
     * 获取死亡最高诊断机构级别代码DIR_RANK_CODE（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     *
     * @return HIGHEST_LEVEL_CODE - 死亡最高诊断机构级别代码DIR_RANK_CODE（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     */
    public String getHighestLevelCode() {
        return highestLevelCode;
    }

    /**
     * 设置死亡最高诊断机构级别代码DIR_RANK_CODE（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     *
     * @param highestLevelCode 死亡最高诊断机构级别代码DIR_RANK_CODE（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     */
    public void setHighestLevelCode(String highestLevelCode) {
        this.highestLevelCode = highestLevelCode == null ? null : highestLevelCode.trim();
    }

    /**
     * 获取死亡最高诊断机构级别中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     *
     * @return HIGHEST_LEVEL_CN - 死亡最高诊断机构级别中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     */
    public String getHighestLevelCn() {
        return highestLevelCn;
    }

    /**
     * 设置死亡最高诊断机构级别中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     *
     * @param highestLevelCn 死亡最高诊断机构级别中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     */
    public void setHighestLevelCn(String highestLevelCn) {
        this.highestLevelCn = highestLevelCn == null ? null : highestLevelCn.trim();
    }

    /**
     * 获取死亡最高诊断机构代码DIR_ORG（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     *
     * @return HIGHEST_ORG_CODE - 死亡最高诊断机构代码DIR_ORG（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     */
    public String getHighestOrgCode() {
        return highestOrgCode;
    }

    /**
     * 设置死亡最高诊断机构代码DIR_ORG（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     *
     * @param highestOrgCode 死亡最高诊断机构代码DIR_ORG（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的代码）
     */
    public void setHighestOrgCode(String highestOrgCode) {
        this.highestOrgCode = highestOrgCode == null ? null : highestOrgCode.trim();
    }

    /**
     * 获取死亡最高诊断机构中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     *
     * @return HIGHEST_ORG_CN - 死亡最高诊断机构中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     */
    public String getHighestOrgCn() {
        return highestOrgCn;
    }

    /**
     * 设置死亡最高诊断机构中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     *
     * @param highestOrgCn 死亡最高诊断机构中文名称（对死亡进行最高效力诊断的机构的级别类别在特定编码体系中的中文名称）
     */
    public void setHighestOrgCn(String highestOrgCn) {
        this.highestOrgCn = highestOrgCn == null ? null : highestOrgCn.trim();
    }

    /**
     * 获取死亡最高诊断依据类别代码CV05.01.037（对根本死因诊断的最高依据在特定编码体系中的代码）
     *
     * @return HIGHEST_DIAG_BASIS_CODE - 死亡最高诊断依据类别代码CV05.01.037（对根本死因诊断的最高依据在特定编码体系中的代码）
     */
    public String getHighestDiagBasisCode() {
        return highestDiagBasisCode;
    }

    /**
     * 设置死亡最高诊断依据类别代码CV05.01.037（对根本死因诊断的最高依据在特定编码体系中的代码）
     *
     * @param highestDiagBasisCode 死亡最高诊断依据类别代码CV05.01.037（对根本死因诊断的最高依据在特定编码体系中的代码）
     */
    public void setHighestDiagBasisCode(String highestDiagBasisCode) {
        this.highestDiagBasisCode = highestDiagBasisCode == null ? null : highestDiagBasisCode.trim();
    }

    /**
     * 获取死亡最高诊断依据类别中文名称（对根本死因诊断的最高依据在特定编码体系中的中文名称）
     *
     * @return HIGHEST_DIAG_BASIS_CN - 死亡最高诊断依据类别中文名称（对根本死因诊断的最高依据在特定编码体系中的中文名称）
     */
    public String getHighestDiagBasisCn() {
        return highestDiagBasisCn;
    }

    /**
     * 设置死亡最高诊断依据类别中文名称（对根本死因诊断的最高依据在特定编码体系中的中文名称）
     *
     * @param highestDiagBasisCn 死亡最高诊断依据类别中文名称（对根本死因诊断的最高依据在特定编码体系中的中文名称）
     */
    public void setHighestDiagBasisCn(String highestDiagBasisCn) {
        this.highestDiagBasisCn = highestDiagBasisCn == null ? null : highestDiagBasisCn.trim();
    }

    /**
     * 获取家属是否同意尸体解剖标志0否 1是（标识患者家属是否同意进行尸体解剖的标志）
     *
     * @return AGREE_AUTOPSY_MARK - 家属是否同意尸体解剖标志0否 1是（标识患者家属是否同意进行尸体解剖的标志）
     */
    public String getAgreeAutopsyMark() {
        return agreeAutopsyMark;
    }

    /**
     * 设置家属是否同意尸体解剖标志0否 1是（标识患者家属是否同意进行尸体解剖的标志）
     *
     * @param agreeAutopsyMark 家属是否同意尸体解剖标志0否 1是（标识患者家属是否同意进行尸体解剖的标志）
     */
    public void setAgreeAutopsyMark(String agreeAutopsyMark) {
        this.agreeAutopsyMark = agreeAutopsyMark == null ? null : agreeAutopsyMark.trim();
    }
