...
@Table(name = "QX_HISTORY_TASK_LOG")
public class QxHistoryTaskLog {
    /**
     * 自增ID[主键]
     */
    @Id
     ...
     * 获取采集类型代码,默认为1标识增量采集
     *
     * @return TASK_TYPE - 采集类型代码,默认为1标识增量采集
     */
     ...
     * 设置采集类型代码,默认为1标识增量采集
     *
     * @param taskType 采集类型代码,默认为1标识增量采集
     */
    ...
    /**
     * 获取采集状态  1正在采集、2采集完成、3采集失败  4采集准备
     *
     * @return DAQ_STATUS - 采集状态  1正在采集、2采集完成、3采集失败  4采集准备
     */
    ...
    /**
     * 设置采集状态  1正在采集、2采集完成、3采集失败  4采集准备
     *
     * @param daqStatus 采集状态  1正在采集、2采集完成、3采集失败  4采集准备
     */
