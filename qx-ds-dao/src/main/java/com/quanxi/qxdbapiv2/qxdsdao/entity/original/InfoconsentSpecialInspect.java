...
@Table(name = "INFOCONSENT_SPECIAL_INSPECT")
public class InfoconsentSpecialInspect {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 特殊检查及特殊治疗项目名称（拟进行的特殊检查及特殊治疗项目名称的描述）
     */
    @Column(name = "SPEC_EXAM_TREAT_ITEM_NAME")
    private String specExamTreatItemName;

    /**
     * 特殊检查及特殊治疗目的（拟进行的特殊检查及特殊治疗的目的描述）
     */
    @Column(name = "SPEC_EXAM_TREAT_PURPOSE")
    private String specExamTreatPurpose;

    /**
     * 特殊检查及特殊治疗可能引起的并发症及风险（拟进行的特殊检查及特殊治疗项目可能引起的并发症及风险描述）
     */
    @Column(name = "SPEC_EXAM_TREAT_COMP_RISK")
    private String specExamTreatCompRisk;
    ...
    /**
     * 获取特殊检查及特殊治疗项目名称（拟进行的特殊检查及特殊治疗项目名称的描述）
     *
     * @return SPEC_EXAM_TREAT_ITEM_NAME - 特殊检查及特殊治疗项目名称（拟进行的特殊检查及特殊治疗项目名称的描述）
     */
    public String getSpecExamTreatItemName() {
        return specExamTreatItemName;
    }

    /**
     * 设置特殊检查及特殊治疗项目名称（拟进行的特殊检查及特殊治疗项目名称的描述）
     *
     * @param specExamTreatItemName 特殊检查及特殊治疗项目名称（拟进行的特殊检查及特殊治疗项目名称的描述）
     */
    public void setSpecExamTreatItemName(String specExamTreatItemName) {
        this.specExamTreatItemName = specExamTreatItemName == null ? null : specExamTreatItemName.trim();
    }

    /**
     * 获取特殊检查及特殊治疗目的（拟进行的特殊检查及特殊治疗的目的描述）
     *
     * @return SPEC_EXAM_TREAT_PURPOSE - 特殊检查及特殊治疗目的（拟进行的特殊检查及特殊治疗的目的描述）
     */
    public String getSpecExamTreatPurpose() {
        return specExamTreatPurpose;
    }

    /**
     * 设置特殊检查及特殊治疗目的（拟进行的特殊检查及特殊治疗的目的描述）
     *
     * @param specExamTreatPurpose 特殊检查及特殊治疗目的（拟进行的特殊检查及特殊治疗的目的描述）
     */
    public void setSpecExamTreatPurpose(String specExamTreatPurpose) {
        this.specExamTreatPurpose = specExamTreatPurpose == null ? null : specExamTreatPurpose.trim();
    }

    /**
     * 获取特殊检查及特殊治疗可能引起的并发症及风险（拟进行的特殊检查及特殊治疗项目可能引起的并发症及风险描述）
     *
     * @return SPEC_EXAM_TREAT_COMP_RISK - 特殊检查及特殊治疗可能引起的并发症及风险（拟进行的特殊检查及特殊治疗项目可能引起的并发症及风险描述）
     */
    public String getSpecExamTreatCompRisk() {
        return specExamTreatCompRisk;
    }

    /**
     * 设置特殊检查及特殊治疗可能引起的并发症及风险（拟进行的特殊检查及特殊治疗项目可能引起的并发症及风险描述）
     *
     * @param specExamTreatCompRisk 特殊检查及特殊治疗可能引起的并发症及风险（拟进行的特殊检查及特殊治疗项目可能引起的并发症及风险描述）
     */
    public void setSpecExamTreatCompRisk(String specExamTreatCompRisk) {
        this.specExamTreatCompRisk = specExamTreatCompRisk == null ? null : specExamTreatCompRisk.trim();
    }
