...
@Table(name = "INFOCONSENT_ANESTHESIA")
public class InfoconsentAnesthesia {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 拟实施麻醉方法编码CV06.00.103（拟对患者开始实施麻醉的方法在特定编码体系中的代码）
     */
    @Column(name = "PLAN_ANES_WAY_CODE")
    private String planAnesWayCode;

    /**
     * 拟实施麻醉方法名称（拟对患者开始实施麻醉的方法在特定编码体系中的名称）
     */
     ...
     * 患者基础疾病（患者所患的基础疾病的描述）
     */
    @Column(name = "PAT_BASIC_DISEASE")
    private String patBasicDisease;

    /**
     * 基础疾病对麻醉可能产生的影响（患者所患的基础疾病可能对麻醉产生影响的特殊情况描述）
     */
    @Column(name = "BASIC_DISEASE_ANES_EFFECT")
    private String basicDiseaseAnesEffect;

    /**
     * 拟行有创操作和监测方法（麻醉过程中拟实施的有创操作和监测的详细描述）
     */
    @Column(name = "PLAN_OP_MONITOR_METHOD")
    private String planOpMonitorMethod;

    /**
     * 麻醉中、麻醉后可能发生的意外及并发症（麻醉中、麻醉后可能发生的意外情况及并发症的详细描述）
     */
    @Column(name = "ANES_POST_ACCIDENT_RISK")
    private String anesPostAccidentRisk;

    /**
     * 使用麻醉镇痛泵标志0否 1是（识患者是否同意使用麻醉镇痛泵的的标志）
     */
    @Column(name = "ANES_PUMP_MARK")
    private String anesPumpMark;

    /**
     * 参加麻醉安全保险标志0否 1是（标识患者是否同意参加麻醉安全保险的标志）
     */
    @Column(name = "ANES_SAFETY_INSUR_MARK")
    private String anesSafetyInsurMark;
    ...
    /**
     * 麻醉医师签名日期时间（麻醉医师进行电子签名时的公元纪年日期和时间的完整描述）
     */
    ...
    /**
     * 获取拟实施麻醉方法编码CV06.00.103（拟对患者开始实施麻醉的方法在特定编码体系中的代码）
     *
     * @return PLAN_ANES_WAY_CODE - 拟实施麻醉方法编码CV06.00.103（拟对患者开始实施麻醉的方法在特定编码体系中的代码）
     */
    ...
    /**
     * 设置拟实施麻醉方法编码CV06.00.103（拟对患者开始实施麻醉的方法在特定编码体系中的代码）
     *
     * @param planAnesWayCode 拟实施麻醉方法编码CV06.00.103（拟对患者开始实施麻醉的方法在特定编码体系中的代码）
     */
    ...
    /**
     * 获取拟实施麻醉方法名称（拟对患者开始实施麻醉的方法在特定编码体系中的名称）
     *
     * @return PLAN_ANES_WAY_NAME - 拟实施麻醉方法名称（拟对患者开始实施麻醉的方法在特定编码体系中的名称）
     */
    ...
    /**
     * 设置拟实施麻醉方法名称（拟对患者开始实施麻醉的方法在特定编码体系中的名称）
     *
     * @param planAnesWayName 拟实施麻醉方法名称（拟对患者开始实施麻醉的方法在特定编码体系中的名称）
     */
    ...
    /**
     * 获取患者基础疾病（患者所患的基础疾病的描述）
     *
     * @return PAT_BASIC_DISEASE - 患者基础疾病（患者所患的基础疾病的描述）
     */
    public String getPatBasicDisease() {
        return patBasicDisease;
    }

    /**
     * 设置患者基础疾病（患者所患的基础疾病的描述）
     *
     * @param patBasicDisease 患者基础疾病（患者所患的基础疾病的描述）
     */
    public void setPatBasicDisease(String patBasicDisease) {
        this.patBasicDisease = patBasicDisease == null ? null : patBasicDisease.trim();
    }

    /**
     * 获取基础疾病对麻醉可能产生的影响（患者所患的基础疾病可能对麻醉产生影响的特殊情况描述）
     *
     * @return BASIC_DISEASE_ANES_EFFECT - 基础疾病对麻醉可能产生的影响（患者所患的基础疾病可能对麻醉产生影响的特殊情况描述）
     */
    public String getBasicDiseaseAnesEffect() {
        return basicDiseaseAnesEffect;
    }

    /**
     * 设置基础疾病对麻醉可能产生的影响（患者所患的基础疾病可能对麻醉产生影响的特殊情况描述）
     *
     * @param basicDiseaseAnesEffect 基础疾病对麻醉可能产生的影响（患者所患的基础疾病可能对麻醉产生影响的特殊情况描述）
     */
    public void setBasicDiseaseAnesEffect(String basicDiseaseAnesEffect) {
        this.basicDiseaseAnesEffect = basicDiseaseAnesEffect == null ? null : basicDiseaseAnesEffect.trim();
    }

    /**
     * 获取拟行有创操作和监测方法（麻醉过程中拟实施的有创操作和监测的详细描述）
     *
     * @return PLAN_OP_MONITOR_METHOD - 拟行有创操作和监测方法（麻醉过程中拟实施的有创操作和监测的详细描述）
     */
    public String getPlanOpMonitorMethod() {
        return planOpMonitorMethod;
    }

    /**
     * 设置拟行有创操作和监测方法（麻醉过程中拟实施的有创操作和监测的详细描述）
     *
     * @param planOpMonitorMethod 拟行有创操作和监测方法（麻醉过程中拟实施的有创操作和监测的详细描述）
     */
    public void setPlanOpMonitorMethod(String planOpMonitorMethod) {
        this.planOpMonitorMethod = planOpMonitorMethod == null ? null : planOpMonitorMethod.trim();
    }

    /**
     * 获取麻醉中、麻醉后可能发生的意外及并发症（麻醉中、麻醉后可能发生的意外情况及并发症的详细描述）
     *
     * @return ANES_POST_ACCIDENT_RISK - 麻醉中、麻醉后可能发生的意外及并发症（麻醉中、麻醉后可能发生的意外情况及并发症的详细描述）
     */
    public String getAnesPostAccidentRisk() {
        return anesPostAccidentRisk;
    }

    /**
     * 设置麻醉中、麻醉后可能发生的意外及并发症（麻醉中、麻醉后可能发生的意外情况及并发症的详细描述）
     *
     * @param anesPostAccidentRisk 麻醉中、麻醉后可能发生的意外及并发症（麻醉中、麻醉后可能发生的意外情况及并发症的详细描述）
     */
    public void setAnesPostAccidentRisk(String anesPostAccidentRisk) {
        this.anesPostAccidentRisk = anesPostAccidentRisk == null ? null : anesPostAccidentRisk.trim();
    }

    /**
     * 获取使用麻醉镇痛泵标志0否 1是（识患者是否同意使用麻醉镇痛泵的的标志）
     *
     * @return ANES_PUMP_MARK - 使用麻醉镇痛泵标志0否 1是（识患者是否同意使用麻醉镇痛泵的的标志）
     */
    public String getAnesPumpMark() {
        return anesPumpMark;
    }

    /**
     * 设置使用麻醉镇痛泵标志0否 1是（识患者是否同意使用麻醉镇痛泵的的标志）
     *
     * @param anesPumpMark 使用麻醉镇痛泵标志0否 1是（识患者是否同意使用麻醉镇痛泵的的标志）
     */
    public void setAnesPumpMark(String anesPumpMark) {
        this.anesPumpMark = anesPumpMark == null ? null : anesPumpMark.trim();
    }

    /**
     * 获取参加麻醉安全保险标志0否 1是（标识患者是否同意参加麻醉安全保险的标志）
     *
     * @return ANES_SAFETY_INSUR_MARK - 参加麻醉安全保险标志0否 1是（标识患者是否同意参加麻醉安全保险的标志）
     */
    public String getAnesSafetyInsurMark() {
        return anesSafetyInsurMark;
    }

    /**
     * 设置参加麻醉安全保险标志0否 1是（标识患者是否同意参加麻醉安全保险的标志）
     *
     * @param anesSafetyInsurMark 参加麻醉安全保险标志0否 1是（标识患者是否同意参加麻醉安全保险的标志）
     */
    public void setAnesSafetyInsurMark(String anesSafetyInsurMark) {
        this.anesSafetyInsurMark = anesSafetyInsurMark == null ? null : anesSafetyInsurMark.trim();
    }
    ...
    /**
     * 获取麻醉医师签名日期时间（麻醉医师进行电子签名时的公元纪年日期和时间的完整描述）
     *
     * @return DOCTOR_SIGNATURE_DATE - 麻醉医师签名日期时间（麻醉医师进行电子签名时的公元纪年日期和时间的完整描述）
     */
    ...
    /**
     * 设置麻醉医师签名日期时间（麻醉医师进行电子签名时的公元纪年日期和时间的完整描述）
     *
     * @param doctorSignatureDate 麻醉医师签名日期时间（麻醉医师进行电子签名时的公元纪年日期和时间的完整描述）
     */
