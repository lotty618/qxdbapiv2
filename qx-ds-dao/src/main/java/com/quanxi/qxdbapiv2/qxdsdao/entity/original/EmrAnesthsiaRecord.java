...
@Table(name = "EMR_ANESTHSIA_RECORD")
public class EmrAnesthsiaRecord {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
     ...
     */
    @Id
    @Column(name = "ANESTHSIA_ID")
    private String anesthsiaId;
     ...
     *
     * @return ANESTHSIA_ID - 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    public String getAnesthsiaId() {
        return anesthsiaId;
    }
     ...
     *
     * @param anesthsiaId 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    public void setAnesthsiaId(String anesthsiaId) {
        this.anesthsiaId = anesthsiaId == null ? null : anesthsiaId.trim();
    }
