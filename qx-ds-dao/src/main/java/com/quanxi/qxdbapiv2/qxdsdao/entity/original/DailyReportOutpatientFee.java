...
@Table(name = "DAILY_REPORT_OUTPATIENT_FEE")
public class DailyReportOutpatientFee {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
     ...
     * 获取挂号费（挂号费）
     *
     * @return FEE_REG - 挂号费（挂号费）
     */
    public BigDecimal getFeeReg() {
        return feeReg;
    }
     ...
     * 设置挂号费（挂号费）
     *
     * @param feeReg 挂号费（挂号费）
     */
    public void setFeeReg(BigDecimal feeReg) {
        this.feeReg = feeReg;
    }
