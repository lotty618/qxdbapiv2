...
@Table(name = "BLOOD_STOCKS_REPORT")
public class BloodStocksReport {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
