...
@Table(name = "INPATIENT_SYMPTOM")
public class InpatientSymptom {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 获取症状描述（患者出现的临床主要症状的详细描述）
     *
     * @return SYMPTOM_NAME - 症状描述（患者出现的临床主要症状的详细描述）
     */
    ...
    /**
     * 设置症状描述（患者出现的临床主要症状的详细描述）
     *
     * @param symptomName 症状描述（患者出现的临床主要症状的详细描述）
     */
     ...
     *
     * @return ONSET_DATE - 发病日期时间（疾病发病症状的首次出现当日的公元纪年日期和时间的完整描述）
     */
     ...
     *
     * @param onsetDate 发病日期时间（疾病发病症状的首次出现当日的公元纪年日期和时间的完整描述）
     */
