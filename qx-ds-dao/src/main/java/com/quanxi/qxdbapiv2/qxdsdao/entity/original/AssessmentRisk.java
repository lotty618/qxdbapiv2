...
public class AssessmentRisk {
    ...
    /**
     * 评定人员签名（评定人员签署的在公安户籍管理部门正式登记注册的姓氏和名称）
     */
    @Column(name = "ASSESSOR")
    private String assessor;

    /**
     * 评定日期时间（进行电子签名时的公元纪年日期和时间的完整描述）
     */
     ...
     *
     * @return RISK_ID - 序列号[主键]（每条记录在数据库中的唯一序号）
     */
     ...
     *
     * @param riskId 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    ...
    /**
     * 获取评定人员签名（评定人员签署的在公安户籍管理部门正式登记注册的姓氏和名称）
     *
     * @return ASSESSOR - 评定人员签名（评定人员签署的在公安户籍管理部门正式登记注册的姓氏和名称）
     */
    ...
    /**
     * 设置评定人员签名（评定人员签署的在公安户籍管理部门正式登记注册的姓氏和名称）
     *
     * @param assessor 评定人员签名（评定人员签署的在公安户籍管理部门正式登记注册的姓氏和名称）
     */
    ...
    /**
     * 获取评定日期时间（进行电子签名时的公元纪年日期和时间的完整描述）
     *
     * @return ASSESS_DATE - 评定日期时间（进行电子签名时的公元纪年日期和时间的完整描述）
     */
    ...
    /**
     * 设置评定日期时间（进行电子签名时的公元纪年日期和时间的完整描述）
     *
     * @param assessDate 评定日期时间（进行电子签名时的公元纪年日期和时间的完整描述）
     */
