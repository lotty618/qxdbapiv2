...
@Table(name = "INFAUST_REPORT_INFO")
public class InfaustReportInfo {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
     ...
     * 获取当前处理部门代码
     *
     * @return SOLVE_DEPT_CODE - 当前处理部门代码
     */
     ...
     * 获取当前处理部门名称
     *
     * @return SOLVE_DEPT_NAME - 当前处理部门名称
     */
