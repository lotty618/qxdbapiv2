...
@Table(name = "EMR_ORTHER_RECORD")
public class EmrOrtherRecord {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
     ...
     *
     * @return ORTHER_ID - 序列号[主键]（每条记录在数据库中的唯一序号）
     */
     ...
     *
     * @param ortherId 序列号[主键]（每条记录在数据库中的唯一序号）
     */
    public void setOrtherId(String ortherId) {
        this.ortherId = ortherId == null ? null : ortherId.trim();
    }
     ...
     * 获取病历类别名称（例如：申请单）
     *
     * @return TEMPLATE_TYPE_CN - 病历类别名称（例如：申请单）
     */
     ...
     * 设置病历类别名称（例如：申请单）
     *
     * @param templateTypeCn 病历类别名称（例如：申请单）
     */
     ...
     * 获取病历名称（例如：手术申请单）
     *
     * @return EMR_TITLE - 病历名称（例如：手术申请单）
     */
