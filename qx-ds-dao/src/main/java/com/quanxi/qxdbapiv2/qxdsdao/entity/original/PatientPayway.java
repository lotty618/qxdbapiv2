...
@Table(name = "PATIENT_PAYWAY")
public class PatientPayway {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 医疗费用支付方式代码[主键]CV07.10.003（就诊者或住院者对其所发生的医疗费用支付的方式代码）
     */
    @Id
    ...
    /**
     * 获取医疗费用支付方式代码[主键]CV07.10.003（就诊者或住院者对其所发生的医疗费用支付的方式代码）
     *
     * @return PAY_WAY_CODE - 医疗费用支付方式代码[主键]CV07.10.003（就诊者或住院者对其所发生的医疗费用支付的方式代码）
     */
    ...
    /**
     * 设置医疗费用支付方式代码[主键]CV07.10.003（就诊者或住院者对其所发生的医疗费用支付的方式代码）
     *
     * @param payWayCode 医疗费用支付方式代码[主键]CV07.10.003（就诊者或住院者对其所发生的医疗费用支付的方式代码）
     */
