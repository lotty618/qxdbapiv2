...
@Table(name = "INFOCONSENT_TRANSFUSION")
public class InfoconsentTransfusion {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 输血史标识名称（既往有无输血经历的分类名称）
     */
    @Column(name = "TRANSFUSE_HISTORY_NAME")
    private String transfuseHistoryName;

    /**
     * 输血指征（受血者接受输血治疗的指征描述）
     */
    @Column(name = "TRANSFUSE_INDICATION")
    private String transfuseIndication;
    ...
    /**
     * 输血品种名称（输入全血或血液成分类别在特定编码体系中的名称）
     */
    @Column(name = "TRANSFUSION_NAME")
    private String transfusionName;

    /**
     * 输血前有关检查项目及结果（输血前与输血相关的检查项目及检查结果描述，如 HBsAg、Anti_HBs、梅毒等）
     */
    @Column(name = "TRANS_PRE_ITEM_RESULT")
    private String transPreItemResult;

    /**
     * 输血方式（输血同意书中本次输血方式的详细描述，如自体输血、异体输血）
     */
    @Column(name = "TRANSFUSION_WAY")
    private String transfusionWay;

    /**
     * 拟定输血日期时间（拟对患者开始进行输血时的公元纪年日期和时间的完整描述）
     */
    @Column(name = "PLAN_TRANSFUSE_DATE")
    private String planTransfuseDate;

    /**
     * 输血风险及可能发生的不良后果（输血治疗存在的风险及可能发生的不良后果的详细描述）
     */
    @Column(name = "TRANSFUSION_RISK")
    private String transfusionRisk;
    ...
    /**
     * 获取输血史标识名称（既往有无输血经历的分类名称）
     *
     * @return TRANSFUSE_HISTORY_NAME - 输血史标识名称（既往有无输血经历的分类名称）
     */
    public String getTransfuseHistoryName() {
        return transfuseHistoryName;
    }

    /**
     * 设置输血史标识名称（既往有无输血经历的分类名称）
     *
     * @param transfuseHistoryName 输血史标识名称（既往有无输血经历的分类名称）
     */
    public void setTransfuseHistoryName(String transfuseHistoryName) {
        this.transfuseHistoryName = transfuseHistoryName == null ? null : transfuseHistoryName.trim();
    }

    /**
     * 获取输血指征（受血者接受输血治疗的指征描述）
     *
     * @return TRANSFUSE_INDICATION - 输血指征（受血者接受输血治疗的指征描述）
     */
    public String getTransfuseIndication() {
        return transfuseIndication;
    }

    /**
     * 设置输血指征（受血者接受输血治疗的指征描述）
     *
     * @param transfuseIndication 输血指征（受血者接受输血治疗的指征描述）
     */
    public void setTransfuseIndication(String transfuseIndication) {
        this.transfuseIndication = transfuseIndication == null ? null : transfuseIndication.trim();
    }
    ...
    /**
     * 获取输血品种名称（输入全血或血液成分类别在特定编码体系中的名称）
     *
     * @return TRANSFUSION_NAME - 输血品种名称（输入全血或血液成分类别在特定编码体系中的名称）
     */
    ...
    /**
     * 设置输血品种名称（输入全血或血液成分类别在特定编码体系中的名称）
     *
     * @param transfusionName 输血品种名称（输入全血或血液成分类别在特定编码体系中的名称）
     */
    ...
    /**
     * 获取输血前有关检查项目及结果（输血前与输血相关的检查项目及检查结果描述，如 HBsAg、Anti_HBs、梅毒等）
     *
     * @return TRANS_PRE_ITEM_RESULT - 输血前有关检查项目及结果（输血前与输血相关的检查项目及检查结果描述，如 HBsAg、Anti_HBs、梅毒等）
     */
    public String getTransPreItemResult() {
        return transPreItemResult;
    }

    /**
     * 设置输血前有关检查项目及结果（输血前与输血相关的检查项目及检查结果描述，如 HBsAg、Anti_HBs、梅毒等）
     *
     * @param transPreItemResult 输血前有关检查项目及结果（输血前与输血相关的检查项目及检查结果描述，如 HBsAg、Anti_HBs、梅毒等）
     */
    public void setTransPreItemResult(String transPreItemResult) {
        this.transPreItemResult = transPreItemResult == null ? null : transPreItemResult.trim();
    }

    /**
     * 获取输血方式（输血同意书中本次输血方式的详细描述，如自体输血、异体输血）
     *
     * @return TRANSFUSION_WAY - 输血方式（输血同意书中本次输血方式的详细描述，如自体输血、异体输血）
     */
    ...
    /**
     * 设置输血方式（输血同意书中本次输血方式的详细描述，如自体输血、异体输血）
     *
     * @param transfusionWay 输血方式（输血同意书中本次输血方式的详细描述，如自体输血、异体输血）
     */
    public void setTransfusionWay(String transfusionWay) {
        this.transfusionWay = transfusionWay == null ? null : transfusionWay.trim();
    }

    /**
     * 获取拟定输血日期时间（拟对患者开始进行输血时的公元纪年日期和时间的完整描述）
     *
     * @return PLAN_TRANSFUSE_DATE - 拟定输血日期时间（拟对患者开始进行输血时的公元纪年日期和时间的完整描述）
     */
    public String getPlanTransfuseDate() {
        return planTransfuseDate;
    }

    /**
     * 设置拟定输血日期时间（拟对患者开始进行输血时的公元纪年日期和时间的完整描述）
     *
     * @param planTransfuseDate 拟定输血日期时间（拟对患者开始进行输血时的公元纪年日期和时间的完整描述）
     */
    public void setPlanTransfuseDate(String planTransfuseDate) {
        this.planTransfuseDate = planTransfuseDate == null ? null : planTransfuseDate.trim();
    }

    /**
     * 获取输血风险及可能发生的不良后果（输血治疗存在的风险及可能发生的不良后果的详细描述）
     *
     * @return TRANSFUSION_RISK - 输血风险及可能发生的不良后果（输血治疗存在的风险及可能发生的不良后果的详细描述）
     */
    public String getTransfusionRisk() {
        return transfusionRisk;
    }

    /**
     * 设置输血风险及可能发生的不良后果（输血治疗存在的风险及可能发生的不良后果的详细描述）
     *
     * @param transfusionRisk 输血风险及可能发生的不良后果（输血治疗存在的风险及可能发生的不良后果的详细描述）
     */
    public void setTransfusionRisk(String transfusionRisk) {
        this.transfusionRisk = transfusionRisk == null ? null : transfusionRisk.trim();
    }
