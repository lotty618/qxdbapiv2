...
@Table(name = "EMR_AUTHORIZE_RECORD")
public class EmrAuthorizeRecord {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
     ...
     * 受托人身份证号码
     */
    @Column(name = "TRUSTEE_IDCAR")
    private String trusteeIdcar;
     ...
     * 受托人签名
     */
    @Column(name = "TRUSTEE_SIGNATURE")
    private String trusteeSignature;

    /**
     * 受托人签名日期时间
     */
    @Column(name = "TRUSTEE_SIGNATURE_DATE")
    private String trusteeSignatureDate;
     ...
     *
     * @return AUTHORIZE_ID - 序列号[主键]（每条记录在数据库中的唯一序号）
     */
     ...
     *
     * @param authorizeId 序列号[主键]（每条记录在数据库中的唯一序号）
     */
     ...
     * 获取受托人身份证号码
     *
     * @return TRUSTEE_IDCAR - 受托人身份证号码
     */
    public String getTrusteeIdcar() {
        return trusteeIdcar;
    }
     ...
     * 设置受托人身份证号码
     *
     * @param trusteeIdcar 受托人身份证号码
     */
    public void setTrusteeIdcar(String trusteeIdcar) {
        this.trusteeIdcar = trusteeIdcar == null ? null : trusteeIdcar.trim();
    }
     ...
     * 获取授权内容
     *
     * @return AUTHORIZE_NOTE - 授权内容
     */
    public String getAuthorizeNote() {
        return authorizeNote;
    }

    /**
     * 设置授权内容
     *
     * @param authorizeNote 授权内容
     */
    public void setAuthorizeNote(String authorizeNote) {
        this.authorizeNote = authorizeNote == null ? null : authorizeNote.trim();
    }

    /**
     * 获取患者签名
     *
     * @return PATIENT_SIGNATURE - 患者签名
     */
     ...
     * 获取患者签名日期时间
     *
     * @return PATIENT_SIGNATURE_DATE - 患者签名日期时间
     */
     ...
     * 设置患者签名日期时间
     *
     * @param patientSignatureDate 患者签名日期时间
     */
     ...
     * 获取受托人签名
     *
     * @return TRUSTEE_SIGNATURE - 受托人签名
     */
    public String getTrusteeSignature() {
     ...
     * 设置受托人签名
     *
     * @param trusteeSignature 受托人签名
     */
    public void setTrusteeSignature(String trusteeSignature) {
        this.trusteeSignature = trusteeSignature == null ? null : trusteeSignature.trim();
    }

    /**
     * 获取受托人签名日期时间
     *
     * @return TRUSTEE_SIGNATURE_DATE - 受托人签名日期时间
     */
    public String getTrusteeSignatureDate() {
        return trusteeSignatureDate;
    }

    /**
     * 设置受托人签名日期时间
     *
     * @param trusteeSignatureDate 受托人签名日期时间
     */
    public void setTrusteeSignatureDate(String trusteeSignatureDate) {
        this.trusteeSignatureDate = trusteeSignatureDate == null ? null : trusteeSignatureDate.trim();
    }
