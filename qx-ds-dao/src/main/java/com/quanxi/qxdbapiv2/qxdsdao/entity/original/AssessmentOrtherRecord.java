...
@Table(name = "ASSESSMENT_ORTHER_RECORD")
public class AssessmentOrtherRecord {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 评估日期时间（患者接受评估结束时的公元纪年日期和时间的完整描述）
     */
     ...
     * 获取评估报告名称（例如、自杀风险评估单）
     *
     * @return REPORT_NAME - 评估报告名称（例如、自杀风险评估单）
     */
     ...
     * 设置评估报告名称（例如、自杀风险评估单）
     *
     * @param reportName 评估报告名称（例如、自杀风险评估单）
     */
    ...
    /**
     * 获取评估报告总得分（对应一次评估报告的最后得分情况）
     *
     * @return ASS_SCORE - 评估报告总得分（对应一次评估报告的最后得分情况）
     */
    ...
    /**
     * 设置评估报告总得分（对应一次评估报告的最后得分情况）
     *
     * @param assScore 评估报告总得分（对应一次评估报告的最后得分情况）
     */
    public void setAssScore(String assScore) {
        this.assScore = assScore == null ? null : assScore.trim();
    }

    /**
     * 获取评估报告等级（对应一次评估报告的存在的等级）
     *
     * @return ASS_LEVEL - 评估报告等级（对应一次评估报告的存在的等级）
     */
    ...
    /**
     * 设置评估报告等级（对应一次评估报告的存在的等级）
     *
     * @param assLevel 评估报告等级（对应一次评估报告的存在的等级）
     */
    public void setAssLevel(String assLevel) {
        this.assLevel = assLevel == null ? null : assLevel.trim();
    }

    /**
     * 获取评估项目所属分类（同属性的评估项归为一类）
     *
     * @return ITEM_TYPE - 评估项目所属分类（同属性的评估项归为一类）
     */
    ...
    /**
     * 设置评估项目所属分类（同属性的评估项归为一类）
     *
     * @param itemType 评估项目所属分类（同属性的评估项归为一类）
     */
    ...
    /**
     * 获取评估项目代码（例如、每个评估项对应的唯一代码）
     *
     * @return ITEM_CODE - 评估项目代码（例如、每个评估项对应的唯一代码）
     */
    ...
    /**
     * 设置评估项目代码（例如、每个评估项对应的唯一代码）
     *
     * @param itemCode 评估项目代码（例如、每个评估项对应的唯一代码）
     */
    ...
    /**
     * 获取评估项目名称（例如、是否想要伤害自己？）
     *
     * @return ITEM_NAME - 评估项目名称（例如、是否想要伤害自己？）
     */
    ...
    /**
     * 设置评估项目名称（例如、是否想要伤害自己？）
     *
     * @param itemName 评估项目名称（例如、是否想要伤害自己？）
     */
     ...
     * 获取评估结果值(每项评估所得到的结果值)
     *
     * @return ITEM_VALUE - 评估结果值(每项评估所得到的结果值)
     */
     ...
     * 设置评估结果值(每项评估所得到的结果值)
     *
     * @param itemValue 评估结果值(每项评估所得到的结果值)
     */
    ...
    /**
     * 获取评估日期时间（患者接受评估结束时的公元纪年日期和时间的完整描述）
     *
     * @return EVALUATION_DATE - 评估日期时间（患者接受评估结束时的公元纪年日期和时间的完整描述）
     */
    ...
    /**
     * 设置评估日期时间（患者接受评估结束时的公元纪年日期和时间的完整描述）
     *
     * @param evaluationDate 评估日期时间（患者接受评估结束时的公元纪年日期和时间的完整描述）
     */
