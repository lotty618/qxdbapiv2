...
@Table(name = "EVENT_GENERAL_OPT_RECORD")
public class EventGeneralOptRecord {
    /**
     * 自增ID——"新建层"应用到唯一主键
     */
    @Id
    ...
    /**
     * 获取送检病理标志（判断该手术是否送检标本进行病理检查）
     *
     * @return PATHOLOGY_MARK - 送检病理标志（判断该手术是否送检标本进行病理检查）
     */
    ...
    /**
     * 设置送检病理标志（判断该手术是否送检标本进行病理检查）
     *
     * @param pathologyMark 送检病理标志（判断该手术是否送检标本进行病理检查）
     */
     ...
     * 获取手术间名称（手术间的中文名称）
     *
     * @return OPERATION_ROOM - 手术间名称（手术间的中文名称）
     */
     ...
     * 设置手术间名称（手术间的中文名称）
     *
     * @param operationRoom 手术间名称（手术间的中文名称）
     */
