...
public class NewlayerDataSourceConfig {
    ...
    @Bean(name = "newlayerJdbcTemplate")
    public JdbcTemplate newlayerJdbcTemplate(@Qualifier("newlayerDataSource") DataSource dataSource) {
        return new JdbcTemplate(dataSource);
    }

    @Bean(name = "newlayerNamedParameterJdbcTemplate")
    public NamedParameterJdbcTemplate newlayerNamedParameterJdbcTemplate(@Qualifier("newlayerDataSource") DataSource dataSource) {
